...
import {
  setSelectedAddons,
  setSelectedDuration,
} from "@/store/PackageSubscription/PackageSubscriptionData";
    ...
    <div className={`dc ${selected ? "selected" : ""}`} onClick={onClick}>
      ...
      <div className="dc-main">
        <div className="dc-left">
          ...
          <div className="dc-save">save {save}</div>
        </div>
        <div>
          ...
          <div className="dc-emi">
            ...
            {emi && (
              <>
                EMI starts with <span className="dc-emi-span">₹ {emi}</span>
              </>
            )}
          </div>
          ...
          <div className="dc-total-before">₹{totalBefore}</div>
        </div>
      </div>
    </div>
  );
    ...
    <div className="ac-main">
      <div className="ac-top">
        <div className="ac-top-left">
          ...
          <div className="ac-price">+ ₹{price}</div>
        </div>
        <div>
...
const SelectDuration = () => {
  ...
  const selectedDuration = useSelector(
    (state) => state.packageSubscriptionData.selectedDuration
  );
  const selectedAddons = useSelector(
    (state) => state.packageSubscriptionData.selectedAddons
  );
