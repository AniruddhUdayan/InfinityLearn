...
const Books = ({ classFor, examFor }) => {
    return (
        <div className="bg-white p-0 lg:p-10 py-0 lg:py-20 pb-0 lg:pb-[20rem]">
            <div className="text-4xl lg:text-5xl font-bold text-center text-[#080E14] bg-[#D4E9FF] lg:bg-white px-4 pt-8 lg:p-0"><span className="text-[#007BFF]">Comprehensive</span> Sri Chaitanya books for {examFor.toUpperCase() ?? 'JEE'}</div>
                ...
                <div className='p-4 lg:p-6 py-8 lg:py-6 rounded-3xl flex flex-col gap-2 justify-evenly bg-[#FEF8DE80] lg:bg-[#F0F3FF]'>
                    ...
                    <div className="flex flex-col gap-4 text-[#52565B] my-4 mb-10 lg:mb-4">
                        <div className='flex gap-2'>
                            ...
                            <div className=' lg:text-lg '>based on the latest {examFor.toUpperCase() ?? 'JEE'} pattern</div>
                        </div>
                        <div className='flex gap-2'>
                            <Image src={check} alt="check" width={20} height={0} className='' />
