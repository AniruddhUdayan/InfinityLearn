...
const Promise = () => {
    return (
        <div className="bg-white p-10 px-56">
            <div className="bg-[#D4E9FF] rounded-xl py-10">
                ...
                <div className='grid grid-cols-4 font-bold text-lg'>
                    <div className='flex flex-col gap-4 items-center px-6 text-center border-[#99CAFF]' style={{ borderWidth: '0px 1px 0px 0px' }}>
