  ...
  return (
    <div>
      <div
        ...
        } rounded-2xl hover:cursor-pointer  bg-white max-md:w-[335px]  w-[377px] justify-evenly max-md:px-3 max-md:p-1 p-5 flex flex-col `}
      >
        ...
        <div className=" my-2 flex gap-[47px]">
          <div className=" flex  flex-col">
            <div className="rounded-2xl p-5 px-7  items-center bg-[#00364E] ">
          ...
          <div className="flex  flex-col">
            <div className=" flex gap-2 items-center">
              ...
              <div className=" font-bold text-[40px] text-[#007BFF]">
                {props.item.ppm}
              </div>
        ...
        <button
          className="text-white items-center h-[52px]   hover:space-x-2 
...
function Plans() {
  ...
  return (
    <div className="bg-[#F3F3F3] max-2xl:pb-[80px] max-md:pb-[31px] min-h-full">
      {/* <Cards /> */}
        ...
        <div className="flex-col">
          <div className=" flex justify-evenly pt-32 max-md:pt-[32px] max-md:flex-col">
            ...
            >
              <div
                ref={containerRef}
                className=" scroll-container max-md:flex-col max-md:overflow-hidden  items-end max-md:px-6 px-3 no-scrollbar flex-nowrap gap-[40px]  overflow-x-auto flex "
              >
          ...
          <div className=" max-2xl:mx-[112px] max-md:mx-[20px] max-2xl:mt-[80px] rounded-xl bg-[#D4E9FF] text-white max-md:flex-col flex w-fll">
            <div
            ...
            >
              <div className=" md:hidden px-5 pt-6 w-full flex   flex-col">
                ...
                <div className=" md:hidden w-full   flex justify-center">
                  <button className=" bg-[#007BFF] mt-[32px] text-white w-fit px-12  rounded-xl p-3">
                    <div className=" flex justify-center gap-2">
            ...
            <div className=" w-1/ max-md:hidden  flex p-12 gap-  flex-col">
              <div className=" text-[#080E14]  font-extrabold text-4xl mb-1">
                mind over matters
              </div>
              <div className=" text-[#080E14]  mb-6 font-extrabold text-4xl">
                with <span className=" text-[#007BFF]">mentors</span>
              </div>
              <div className=" text-[#52565B] text-[20px] font-[400]">
                {"We’ll guide you in making a study plan that helps"}
              </div>
              <div className=" text-[#52565B] text-[20px] font-[400]">
                {"you study efficiently and in a balanced manner!"}
              </div>
              <button className=" bg-[#007BFF] mt-[48px] text-white w-fit px-12  rounded-xl p-3">
                <div className=" flex justify-center gap-2">
                  <div className="">lets plan together </div>
                  <div>
                    <GoArrowUpRight size={24} />
