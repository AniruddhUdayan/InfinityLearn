...
const FacultyCard = ({ ref2, name, image, headline, subject, usp }) => {
  return (
    <div
      ref={ref2}
      className="min-w-full  flex-shrink-0 flex justify-center  snap-center lg:min-w-[calc(33%-0.25rem)]"
    >
      <div className="bg-white rounded-xl p-2 flex flex-col gap-2 items-center shadow-[0px_4px_20px_0px_#0060A933] w-fit">
        ...
        <div className="flex gap-2 mb-2">
          <div className="bg-[#FFE4CC] text-[#FF7A00] p-2 py-1 rounded-lg border border-[#FF7A00]">
            {subject}
          </div>
          <div className="bg-[#D6F4DE] text-[#169C38] p-2 py-1 rounded-lg border border-[#169C38]">
            {usp}
          </div>
        </div>
      </div>
