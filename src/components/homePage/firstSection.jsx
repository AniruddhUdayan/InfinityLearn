...
function FirstSection() {
  ...
  return (
    <div className="flex lg:px-5 pb-32 max-md:pt-16  max-md:pb-8 w-full max-md:min-h-screen items-center justify-around bg-[#007BFF] max-md:flex-col max-md:h-fit">
